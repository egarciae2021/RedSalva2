						...
						<div class="card-body">
							<form method="POST" action="/gracias-por-consultar">
								...
								<div class="d-grid gap-4">
									...
									<button type="submit" class="btn btn-naranja d-md-block">Solicitar una cita</button>
								</div>
							</form>
						</div>
					</div>

					<div class="col-md-6 d-md-flex justify-content-center flex-column fondo-celeste-bajo p-2 p-md-4" style="background-image: url(/images/wave-pattern.svg);">

						<h2 class="text-center text-primary py-5">¿Quieres contactarnos?</h2>
						<a class="card card-transition mb-4" href="tel:+513174000" target="_blank">
							<div class="card-body">
								<div class="d-flex">
									<div class="flex-shrink-0">
										<i class="fa fa-phone fs-1 text-dark"></i>
									</div>
									<div class="flex-grow-1 ms-4 my-2">
										<h5 class="card-title">Llámanos</h5>
										<p class="card-text">(+51) 317 4000</p> 
									</div>
								</div>
							</div>
						</a>
						<a class="card card-transition mb-4" href="mailto:informes@clinicamontesur.com" target="_blank">
							<div class="card-body">
								<div class="d-flex">
									<div class="flex-shrink-0">
										<i class="fa fa-envelope fs-1 text-dark"></i>
									</div>
									<div class="flex-grow-1 ms-4">
										<h5 class="card-title">Informes</h5>
										<p class="card-text d-none d-md-inline">informes@clinicamontesur.com</p>
										<p class="card-text d-inline d-md-none">Click aquí</p>
									</div>
								</div>
							</div>
						</a>
						<a class="card card-transition mb-4" href="https://maps.app.goo.gl/UMy1a9S5FwdtDhUU8" target="_blank">
							<div class="card-body">
								<div class="d-flex">
									<div class="flex-shrink-0">
										<i class="fa fa-map-marker fs-1 text-dark"></i>
									</div>
									<div class="flex-grow-1 ms-4">
										<h5 class="card-title">Dirección</h5>
										<p class="card-text">Av. El Polo 505. Urb. El Derby Santiago de Surco - Lima</p>
									</div>
								</div>
							</div>
						</a>
