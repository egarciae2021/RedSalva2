        ...
        function renderMedicos() {
            ...
            medicosContainer.innerHTML = medicosPagina.map(medico => {
                const horariosHTML = medico.horarios.map(horario => {
                    ...
                    const waLinkManana = `https://wa.me/51979708672?text=Hola,%20quiero%20una%20cita%20con%20${medico.sexo == '1' ? 'la Dra.' : 'el Dr.'} ${medico.nombre} en el horario ${dia} ${manana}`;
                    const waLinkTarde = `https://wa.me/51979708672?text=Hola,%20quiero%20una%20cita%20con%20${medico.sexo == '1' ? 'la Dra.' : 'el Dr.'} ${medico.nombre} en el horario ${dia} ${tarde}`;
                    return `
                        <p class="d-flex">
                ...
                const waLink = `https://wa.me/51979708672?text=Hola,%20deseo%20una%20cita%20con%20${medico.sexo == '1' ? 'la Dra.' : 'el Dr.'} ${medico.nombre}`;
