	...
	<div class="container">
		<div class="row">
			<div class="col-md-10 offset-lg-1">
				<p>Procedimientos médicos destinados al tratamiento o manejo complementario de las condiciones que generan dolor crónico. Se realizan de acuerdo a la complejidad en áreas de procedimientos bajo sedoanalgesia y monitoreo de funciones vitales.</p>
				<ul>
					<li>Colocación de Catéteres Neuroaxiales</li>
					<li>Bloqueo de Nervios con Guía Ecográfica / Fluoroscopia</li>
					<li>Bloqueo de Facetas con Guía Ecográfica / Fluoroscopia</li>
					<li>Bloqueo de Ganglios con Guía Ecográfica / Fluoroscopia</li>
				</ul>
				<p class="color-azul h5">Formularios:</p>
				<ul>
					<li>Ficha de Bloqueo / Intervencionismo</li>
					<li>Receta Médica</li>
				</ul>
				<p class="color-azul h5">Ambiente:</p>
				<p>Sala de Procedimientos</p>
