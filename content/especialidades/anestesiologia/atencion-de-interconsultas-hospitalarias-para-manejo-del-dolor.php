	...
	<div class="container">
		<div class="row">
			<div class="col-md-10 offset-lg-1">
				<p>La atención de interconsultas hospitalarias para manejo del dolor se brindará de manera continua para manewjo del dolor agudo, crisis de hiperalgesia e intervencionismo analgésico.</p>
				<ul>
					<li>Interconsulta Médica Especializada</li>
					<li>Analgesia Regional Continua</li>
					<li>Analgesia mediante bomba PCA controlada por el usuario</li>
					<li>Analgesia mediante bloqueos</li>
					<li>Seguimiento durante hospitalización.</li>
				</ul>
				<p class="color-azul h5">Formularios:</p>
				<ul>
					<li>Ficha de Respuesta de Interconsulta</li>
					<li>Receta Médica (cuando corresponda)</li>
				</ul>
				<p class="color-azul h5">Ambiente:</p>
				<ul>
					<li>Sala de Hospitalización y Cuidados Intensivos</li>
				</ul>
