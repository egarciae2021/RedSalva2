	...
	<div class="container">
		<div class="row">
			<div class="col-md-10 offset-lg-1">
				<p>El dolor es la causa más frecuente de sufrimiento e incapacidad que afecta la calidad de vida de las personas. En los países industrializados 15 a 20 % de los habitantes padece de dolor agudo al menos una vez al año y 25 a 30% experimentan la forma crónica como una experiencia sensorial y emocional desagradable producto de un daño real o potencial que puede ser permanente o intermitente.</p>
				<p>La consulta médica además abarca colocación y/ o cambio de dispositivos, parches, ajuste de bombas de infusión, infiltraciones, bloqueo de puntos dolorosos e infusiones de analgésicos y neuromoduladores entre otros.</p>
				<p class="color-azul h5">Formularios:</p>
				<ul>
					<li>Ficha de Tratamiento del Dolor</li>
					<li>Receta Médica</li>
					<li>Derivación a procedimientos (cuando corresponda).</li>
				</ul>
				<p class="color-azul h5">Ambiente:</p>
				<ul>
					<li>Consultorio Médico Estándar</li>
					<li>Sala de tratamiento endovenoso ambulatorio con sillón</li>
				</ul>
