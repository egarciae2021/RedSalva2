	...
	<div class="container">
		<div class="row">
			<div class="col-md-10 offset-lg-1">
				<p>El cono LEEP (procedimiento de escisión electroquirúrgica con asa) se utiliza para remover tejido anormal del cuello uterino, a menudo detectado en pruebas de Papanicolaou anormales. Este procedimiento ayuda a prevenir el desarrollo de cáncer cervical.</p>
				<p>En nuestra clínica, realizamos el cono LEEP con tecnología avanzada y un enfoque centrado en el paciente. Nos aseguramos de que cada procedimiento se realice de manera segura y eficaz, proporcionando un cuidado integral y seguimiento continuo para asegurar la salud cervical de nuestras pacientes.</p>
