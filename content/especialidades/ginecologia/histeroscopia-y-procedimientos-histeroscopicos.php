	...
	<div class="container">
		<div class="row">
			<div class="col-md-10 offset-lg-1">
				<p>La histeroscopia es un procedimiento mínimamente invasivo que permite a los ginecólogos visualizar y tratar el interior del útero utilizando un histeroscopio. Este método se utiliza para diagnosticar y tratar condiciones como pólipos, fibromas y adherencias uterinas.</p>
				<p>En nuestra clínica, realizamos histeroscopias con tecnología avanzada y un enfoque personalizado. Nos aseguramos de que cada procedimiento se realice con precisión y cuidado, proporcionando una recuperación rápida y resultados óptimos para nuestras pacientes.</p>
