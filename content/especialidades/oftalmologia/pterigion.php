	...
	<div class="container">
		<div class="row">
			<div class="col-md-10 offset-lg-1">
				<p>La cirugía de pterigión se realiza para remover el crecimiento anormal de tejido en la conjuntiva del ojo, que puede invadir la córnea y afectar la visión. Este procedimiento mejora la apariencia y la función del ojo.</p>
				<p>En nuestra clínica, proporcionamos cirugía de pterigión con técnicas avanzadas y un enfoque personalizado. Nuestros oftalmólogos se aseguran de que cada paciente reciba una atención detallada y un seguimiento integral, asegurando una recuperación efectiva y resultados estéticamente agradables.</p>
