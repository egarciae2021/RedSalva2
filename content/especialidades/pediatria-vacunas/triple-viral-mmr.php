	...
	<div class="container">
		<div class="row">
			<div class="col-md-10 offset-lg-1">
				<p>Esta vacuna ayuda a prevenir el sarampión, rubeola y paperas.</p>
				...
				<ul>
					...
					<li><strong>Refuerzo:</strong><br>A los 4 años.</li>
				</ul>
				...
				<p><small>*La Cuadruple Viral ayuda a prevenir el sarampión, rubeola, paperas y varicela.</small></p>
