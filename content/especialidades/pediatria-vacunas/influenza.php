	...
	<div class="container">
		<div class="row">
			<div class="col-md-10 offset-lg-1">
				<p>Esta vacuna protege 4 tipos de influenza: AH1N1, AH3N2, Influenza Tipo B Yamagata e Influenza Tipo B Victoria.</p>
				<p class="color-azul h5">¿Cuándo debe colocarse esta vacuna?</p>
				<p>Los niños deben recibir 1 dosis y 1 refuerzo:</p>
				<ul>
					<li><strong>Primera dosis:</strong><br>A los 7 meses.</li>
					<li><strong>Refuerzo:</strong><br>A los 8 meses.</li>
				</ul>
				<p><small>* A partir de los 2 años, se debe colocar una dosis al año.</small>
				<p class="color-azul h5">¿Esta vacuna tiene efectos secundarios?</p>
				<p>En algunos casos se presenta fiebre ligera, enrojecimiento e hinchazón.</p>
