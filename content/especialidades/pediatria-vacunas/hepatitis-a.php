	...
	<div class="container">
		<div class="row">
			<div class="col-md-10 offset-lg-1">
				<p>Transmitida a través alimentos contaminados con el virus de Hepatitis A (VHA), por vía fecal a oral.</p>
				<p class="color-azul h5">¿Cuándo debe colocarse esta vacuna?</p>
				<p>Los niños deben recibir 1 dosis y 1 refuerzo:</p>
				<ul>
					<li><strong>Primera dosis:</strong><br>A los 13 meses.</li>
					<li><strong>Refuerzo:</strong><br>A los 19 meses.</li>
				</ul>
				<p class="color-azul h5">¿Esta vacuna tiene efectos secundarios?</p>
				<p>Puede causar en algunos casos dolor o enrojecimiento en el lugar donde se aplicó la inyección, fiebre muy baja, dolor de cabeza y cansancio.</p>
