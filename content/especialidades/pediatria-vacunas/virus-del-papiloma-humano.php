	...
	<div class="container">
		<div class="row">
			<div class="col-md-10 offset-lg-1">
				<p>Protege contra la infección por ciertas cepas del VPH, que se transmite a través de relaciones sexuales.</p>
				<p class="color-azul h5">¿Cuándo debe colocarse esta vacuna?</p>
				<p>Los niños deben recibir 2 dosis:</p>
				<ul>
					<li><strong>Primera dosis:</strong><br>A los 9 años.</li>
					<li><strong>Segunda dosis:</strong><br>A los 9 años y 6 meses.</li>
				</ul>
				<p class="color-azul h5">¿Esta vacuna tiene efectos secundarios?</p>
				<p>Puede generar dolor, hinchazón o enrojecimiento en la zona en la que se aplicó la inyección.</p>
