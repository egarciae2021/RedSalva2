	...
	<div class="container">
		<div class="row">
			<div class="col-md-10 offset-lg-1">
				...
				<p>En la Clínica Montesur, nos especializamos en la realización de naso laringoscopias flexibles, asegurando un diagnóstico preciso y una atención de alta calidad. Nuestro equipo de otorrinolaringólogos está altamente capacitado para realizar este procedimiento con la mayor precisión, permitiendo así una evaluación detallada y una planificación adecuada del tratamiento necesario para cada paciente.</p>
