	...
	<div class="container">
		<div class="row">
			<div class="col-md-10 offset-lg-1">
				...
				<p>En la Clínica Montesur, nuestros especialistas en mastología están capacitados para diagnosticar y tratar la mastitis granulomatosa. Utilizamos un enfoque multidisciplinario para proporcionar un tratamiento eficaz y un seguimiento cercano, asegurando que nuestras pacientes reciban el mejor cuidado posible.</p>
