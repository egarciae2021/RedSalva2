...
<section class="container my-5">
                            ...
                            <?php if ($mostrarPreviaCita): ?>
                                <td>
                                    <?php if ($detalles['previa_cita']): ?>
                                        <a href="https://wa.me/51979708672?text=Hola,%20quiero%20una%20cita%20con%20<?php echo urlencode(($medico['sexo'] == '1' ? 'Dra.' : 'Dr.') . ' ' . $medico['nombre'] . ' ' . $medico['paterno'] . ' ' . $medico['materno'] . ' el ' . $dia . ' bajo modalidad previa cita'); ?>"
                            ...
                            <?php if ($mostrarManana): ?>
                                <td>
                                    <?php if ($detalles['manana']): ?>
                                        <a href="https://wa.me/51979708672?text=Hola,%20quiero%20una%20cita%20con%20<?php echo urlencode(($medico['sexo'] == '1' ? 'Dra.' : 'Dr.') . ' ' . $medico['nombre'] . ' ' . $medico['paterno'] . ' ' . $medico['materno'] . ' el ' . $dia . ' a las ' . $detalles['manana']); ?>"
                                           class="color-azul color-naranja-hover"
                                           data-bs-toggle="tooltip"
                            ...
                            <?php if ($mostrarTarde): ?>
                                <td>
                                    <?php if ($detalles['tarde']): ?>
                                        <a href="https://wa.me/51979708672?text=Hola,%20quiero%20una%20cita%20con%20<?php echo urlencode(($medico['sexo'] == '1' ? 'Dra.' : 'Dr.') . ' ' . $medico['nombre'] . ' ' . $medico['paterno'] . ' ' . $medico['materno'] . ' el ' . $dia . ' a las ' . $detalles['tarde']); ?>"
                                           class="color-azul color-naranja-hover"
                                           data-bs-toggle="tooltip"
    ...
    <div class="row mt-4">
        <div class="col-12 text-center">
            <a href="https://wa.me/51979708672?text=Hola,%20deseo%20una%20cita%20con%20<?php echo urlencode(($medico['sexo'] == '1' ? 'Dra.' : 'Dr.') . ' ' . $medico['nombre'] . ' ' . $medico['paterno'] . ' ' . $medico['materno']); ?>"
